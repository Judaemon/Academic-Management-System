...
<aside class="fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto bg-bg md:hidden" x-show="isSideMenuOpen"
    ...
    <div class="py-4 text-gray-500 dark:text-gray-400">
        <a class="" href="{{ route('dashboard') }}">
            <div class="flex flex-row items-center px-4">
                ...
                <h1 class="ml-4 text-2xl font-bold text-text">{{ setting('institute_acronym') }}</h1>
            </div>
        </a>
        <ul class="mt-6">
            ...
            <li class="relative px-6 py-3">
                ...
                <button
                    class="text-text inline-flex items-center justify-between w-full text-sm font-semibold transition-colors duration-150  dark:hover:text-gray-200"
                    @click="toggleAccountingMenu" aria-haspopup="true">
                    <span class="inline-flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-5 h-5 fill-text">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M15.75 15.75V18m-7.5-6.75h.008v.008H8.25v-.008zm0 2.25h.008v.008H8.25V13.5zm0 2.25h.008v.008H8.25v-.008zm0 2.25h.008v.008H8.25V18zm2.498-6.75h.007v.008h-.007v-.008zm0 2.25h.007v.008h-.007V13.5zm0 2.25h.007v.008h-.007v-.008zm0 2.25h.007v.008h-.007V18zm2.504-6.75h.008v.008h-.008v-.008zm0 2.25h.008v.008h-.008V13.5zm0 2.25h.008v.008h-.008v-.008zm0 2.25h.008v.008h-.008V18zm2.498-6.75h.008v.008h-.008v-.008zm0 2.25h.008v.008h-.008V13.5zM8.25 6h7.5v2.25h-7.5V6zM12 2.25c-1.892 0-3.758.11-5.593.322C5.307 2.7 4.5 3.65 4.5 4.757V19.5a2.25 2.25 0 002.25 2.25h10.5a2.25 2.25 0 002.25-2.25V4.757c0-1.108-.806-2.057-1.907-2.185A48.507 48.507 0 0012 2.25z" />
                        </svg>
                        <span class="ml-4 text-text">Accounting</span>
                    </span>
                    <svg class="w-4 h-4 fill-text" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                ...
                <template x-if="isAccountingMenuOpen">
                    <ul x-transition:enter="transition-all ease-in-out duration-300"
                        ...
                        class="p-2 mt-2 space-y-2 overflow-hidden text-sm font-medium bg-white/10 rounded-md shadow-inner dark:text-gray-400 dark:bg-gray-900"
                        aria-label="submenu">
            ...
            <li class="relative px-6 py-3">
                @if (request()->routeIs('subjects.index') ||
                    ...
                    request()->routeIs('grade_level.index'))
            ...
            <li class="relative px-6 py-3">
                @if (request()->routeIs('roles.index') ||
                    ...
                    request()->routeIs('academic_year.index'))
                ...
                <button
                    ...
                    <span class="inline-flex items-center">
                        ...
                        <svg class="w-5 h-5 fill-text" stroke="currentColor" stroke-width="2"
                ...
                <template x-if="isAdminMenuOpen">
                    <ul x-transition:enter="transition-all ease-in-out duration-300"
                        ...
                        x-transition:leave="transition-all ease-in-out duration-300"
                        x-transition:leave-start="opacity-100 max-h-xl" x-transition:leave-end="opacity-0 max-h-0"
                        class="p-2 mt-2 space-y-2 overflow-hidden text-sm font-medium text-gray-500 rounded-md shadow-inner bg-white/10 dark:text-gray-400 dark:bg-gray-900"
                        aria-label="submenu">
