                    ...
                    <div class="sm:col-span-1 md:col-span-12 rounded-lg border shadow-xs p-2">
                        <div class="flex flex-col-reverse gap-4 md:flex-row">
                            <div class="md:grid-flow-col md:grid-cols-3 md:grid-rows-3 gap-4 grid md:w-8/12">
                                <div class="md:col-span-2 md:col-start-1 md:row-span-2 bg-blue-100">
                                    <h2 class="font-semibold">{{ $student->firstname }} {{ $student->lastname }}</h2>
                                    <p>{{ $student->mobilenumber }} | {{ $student->email }}</p>
                                    <p>{{ $student->grade_level }}</p>
                                </div>
                                <div class="md:col-span-1 md:col-start-3 md:row-span-2 bg-red-100 ">
                                    <p class="">{{ $student->status }}</p>
                                </div>
                                <div class="md:col-span-3 md:row-span-1 md:row-start-3 bg-green-100">
