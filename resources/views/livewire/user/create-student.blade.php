    ...
    <x-card title="Create Student">
        <form wire:submit.prevent="save">
            <div class="grid sm:grid-cols-2 md:grid-cols-12 gap-4">
                ...
                <div class="sm:col-span-1 md:col-span-4">
                    <x-input wire:model.defer="school_elementarygrad" label="Year Graduated (Elementary)"
                        placeholder="Year" />
                </div>

                <div class="sm:col-span-1 md:col-span-4">
                    <x-input wire:model.defer="school_juniorhigh" label="Junior High School"
                ...
                <div class="sm:col-span-1 md:col-span-4">
                    <x-input wire:model.defer="esc" label="Education Service Contracting (ESC) No."
                        placeholder="" />
                </div>
