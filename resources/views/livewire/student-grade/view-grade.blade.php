        ...
        <form wire:submit.prevent="save">
            <div class="form-container grid grid-cols-12 gap-4">
                ...
                <section class="container col-span-12">
                    ...
                    <div class="grid grid-cols-12 gap-2 lg:gap-4">
                        <div class="col-span-12 md:col-span-4 lg:col-span-3">
                            <x-input readonly value="{{ $grade->student->last_name }}" label="Student"
                                placeholder="" />
                        </div>
                    </div>
                </section>
                ...
                <section class="container col-span-12">
                    ...
                    <div class="grid grid-cols-12 gap-2 lg:gap-4">
                        <div class="col-span-12 md:col-span-4 lg:col-span-3">
                            <x-input readonly value="{{ $grade->first_quarter }}" label="First Quarter"
                                placeholder="" />
                        </div>

                        <div class="col-span-12 md:col-span-4 lg:col-span-3">
                            <x-input readonly value="{{ $grade->second_quarter }}" label="Second Quarter"
                                placeholder="" />
                        </div>

                        <div class="col-span-12 md:col-span-4 lg:col-span-3">
                            <x-input readonly value="{{ $grade->second_quarter }}" label="Third Quarter"
                                placeholder="" />
                        </div>

                        <div class="col-span-12 md:col-span-4 lg:col-span-3">
                            <x-input readonly value="{{ $grade->fourth_quarter }}" label="Fourth Quarter"
                                placeholder="" />
                        </div>
                    </div>
                </section>
