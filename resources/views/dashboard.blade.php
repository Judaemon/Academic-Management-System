<x-app-layout>
    @if (empty(Auth::user()->password_changed_at))
        <div class="hidden">
            <div x-init="livewire.emit('openModal', 'user.change-password')"></div>
        </div>
    @endif
    ...
    <div class="p-4 bg-white rounded-lg shadow-xs">
        ...
        @foreach ($announcements as $announcement)
            <div class="py-2">
                <div
                    class="flex flex-col p-4 bg-white shadow-md border-2 border-iscp_primary hover:shadow-lg rounded-2xl">
                    <div class="flex items-center justify-between">
                        <div class="flex justify-start items-center w-full">
                            ...
                            <div class="flex flex-col pl-5 items-center justify-start w-full">
                                ...
                                <div class="font-bold text-lg w-full leading-none ml-4 uppercase">
                                    {{ $announcement->title }}
                                </div>
