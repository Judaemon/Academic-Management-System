<x-app-layout>
    <div class="lg:p-4 lg:flex lg:justify-between items-center">
        <h2 class="mb-4 lg:mb-0 font-semibold text-2xl text-gray-800 leading-tight">Settings</h2>
        ...
        <div class="overflow-hidden lg:max-w-lg flex justify-between w-full bg-white rounded-lg shadow-md">
            <div class="px-4 py-2 -mx-3">
                <div class="mx-3">
                    ...
                    <p class="text-sm text-gray-600">You are edting <span class="font-bold">system setting</span> this will affect the whole system.</p>
                </div>
            </div>
